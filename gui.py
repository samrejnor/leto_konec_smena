...
from PyQt6.QtWidgets import (
    ...
    QFileDialog, QFrame, QStackedWidget, QScrollArea, QProgressBar
)
...
class ImageUploadWidget(QFrame):
    ...
    def clear_images(self):
        """Очищает все изображения и возвращает плейсхолдер"""
...
class MainWindow(QWidget):
    ...
    def analyze_images(self):
        ...
        # Удаляем изображения из превью и возвращаем плейсхолдер
        self.upload_widget.clear_images()
        
        # Очистим старый анализ (кроме заголовка)
        ...
        # Скрываем плейсхолдер перед рендером анализа
        self.placeholder_frame.hide()

        IMAGE_PROCESSOR.initialize_images(image_paths)
        analysis_data = IMAGE_PROCESSOR.turn_to_llm()  # dict с данными анализа
